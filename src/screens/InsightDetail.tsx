    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6 py-20 text-center">
          ...
          <button onClick={() => router.push('/')} className="text-primary hover:text-gold transition-colors">{t('notFound.returnHome')}</button>
        </div>
        <Footer />
      </div>
    );
    ...
    <div className="min-h-screen">
      ...
      <article className="py-20 md:py-32">
        <div className="container mx-auto px-6 max-w-4xl">
          <button onClick={() => router.push('/#insights')} className="inline-flex items-center text-muted-foreground hover:text-primary transition-colors mb-8 group">
          ...
          <footer className="mt-16 pt-8 border-t border-border text-center">
            <button onClick={() => router.push('/#insights')} className="inline-flex items-center px-8 py-3 border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 font-body text-sm font-light tracking-wide">
              {t('insights.viewMore')}
            </button>
          </footer>
        </div>
